...
default_mapper.solr_name("foo",:string,:searchable)     # returns foo_teim
default_mapper.solr_name("foo",:date,:searchable)       # returns foo_dtim
default_mapper.solr_name("foo",:integer,:searchable     # returns foo_iim
...
default_mapper.solr_name("foo",:string,:sortable)       # returns foo_ssort
...
FieldMapper allows defaults:

<pre>
default_mapper.default_index_types << :searchble
default_mapper.solr_names_and_values("foo","bar",:string,[])                              # returns searchable by default => {"foo_teim"=>["bar"]}
default_mapper.default_index_types << :displayable
default_mapper.solr_names_and_values("foo","bar",:string,[])                              # returns searchable and facetable by default => {"foo_ssm"=>["bar"], "foo_teim"=>["bar"]}
</pre>
...
extractor.xml_to_solr(xml)      # returns {:foo_teim=>"bar", :bar_teim=>"baz"}
</pre>
